...
import {
  ens_normalize
} from "./chunk-MFAA4CZR.js";
import "./chunk-T2XNSUVJ.js";
import "./chunk-2M6KNVYN.js";
import {
...
import {
  ...
  polygonAmoy,
  sepolia
} from "./chunk-DRI43TFD.js";
import "./chunk-K6XUH2FC.js";
import {
  http,
  withRetry,
  withTimeout
} from "./chunk-W3D2PWNV.js";
import "./chunk-PKISX2ND.js";
import "./chunk-H3SBBZDP.js";
import {
...
import {
  init_sha256
} from "./chunk-ZTKNMA3L.js";
import {
  init_sha3,
  keccak_256
} from "./chunk-2IV5BHI4.js";
import {
  SHA256_IV,
  init_md,
  init_sha2
} from "./chunk-WB4ZDEFE.js";
import {
  Hash,
  abytes,
  add,
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await import("./dist-7HCVCMBS.js");
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-CXBSWFHH.js");
    ...
    async getProvider() {
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-HPXQ4VWK.js");
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-CFBYQSAK.js");
    ...
    async getProvider({ chainId } = {}) {
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-5WORGWDF.js");

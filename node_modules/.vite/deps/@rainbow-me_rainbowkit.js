...
import "./chunk-JM2A37ZF.js";
import {
  ens_normalize
} from "./chunk-AOG2ERQF.js";
import "./chunk-3HDD3I2M.js";
...
import {
  ...
  useSignMessage,
  useSwitchChain
} from "./chunk-IN5MAJLZ.js";
import {
  useQuery
} from "./chunk-PY5LSZCT.js";
import {
  init_ed25519
} from "./chunk-HNUTHHSS.js";
import {
...
import {
  ...
  withRetry,
  withTimeout
} from "./chunk-KDSCH7LP.js";
import "./chunk-SXNYCJDA.js";
import {
  import_index,
  init_eventemitter3
} from "./chunk-ISET6NDI.js";
...
import {
  ...
  polygonAmoy,
  sepolia
} from "./chunk-OPXFQYYK.js";
import "./chunk-5VOSICEJ.js";
import "./chunk-FVACN2Z6.js";
import {
...
import {
  init_sha256
} from "./chunk-HEKIUWGN.js";
import {
  init_sha3,
  keccak_256
} from "./chunk-LNRRGFZX.js";
import {
  SHA256_IV,
  init_md,
  init_sha2
} from "./chunk-RDYPJANH.js";
import {
  Hash,
  abytes,
  add,
...
function encode2(ver, ecc, data, type2, encoder = utf8ToBytes2) {
  let encoded = "";
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await import("./dist-DITSJVRZ.js");
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-UQVOFWMK.js");
    ...
    async getProvider() {
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-Y6TQHW3W.js");
    ...
    async getProvider() {
      async function initProvider() {
        const MetaMaskSDK = await (async () => {
          const { default: SDK } = await import("./metamask-sdk-NRVQ4DGF.js");
          if (typeof SDK !== "function" && typeof SDK.default === "function")
            return SDK.default;
          return SDK;
        })();
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-RMIIM3LB.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-6MA57L35.js");
    ...
    async getProvider({ chainId } = {}) {
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-GJUAIDS2.js");
